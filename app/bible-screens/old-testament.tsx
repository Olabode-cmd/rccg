...
const OldTestament = () => {
    ...
    // Define Old Testament book indices (0-38)
    const OLD_TESTAMENT_BOOKS = Array.from({ length: 39 }, (_, i) => i);
    ...
    useEffect(() => {
        const oldTestamentBooks = getTestamentBooks();
        setBookNames(oldTestamentBooks);
    }, []);

    // Get book names for Old Testament
    const getTestamentBooks = () => {
        return OLD_TESTAMENT_BOOKS.map(index => {
